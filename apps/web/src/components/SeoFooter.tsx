...
export function SeoFooter() {
  return (
    <footer className="border-t border-border bg-bg px-4 py-8 text-sm text-fg-muted">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <nav className="flex flex-wrap gap-x-4 gap-y-1.5 border-t border-border/60 pt-4">
          ...
          <Link href="/stats" className="hover:text-fg hover:underline">Статистика</Link>
          <Link href="/timelapse" className="hover:text-fg hover:underline">Тайм-лапс за добу</Link>
          <Link href="/embed" className="hover:text-fg hover:underline">Віджет для сайту</Link>
          <Link href="/about" className="hover:text-fg hover:underline">Про проєкт</Link>
          <a href="/deshahed.apk" download className="text-safe hover:text-safe/80 hover:underline">Android-застосунок</a>
        </nav>

        <p className="border-t border-border/60 pt-4 text-[12px] leading-relaxed text-fg-subtle">
          <strong className="text-fg-muted">deshahed</strong> — карта повітряних
